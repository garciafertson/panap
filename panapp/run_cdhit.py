...
import subprocess
def cdhit_hierarquical(filename):
    subprocess.call(["cd-hit","-i",filename, "-o", "panap_100", "-c", "1", "-d", "0"])
    ...
    cmd=["clstr_rev.pl","panap_100.clstr","panap_95.clstr"]
    with open("panap_100-95.clstr","w", 0) as out:
        subprocess.call(cmd, stdout=out)
    
    cmd=["clstr_rev.pl","panap_100-95.clstr","panap_90.clstr"]
    with open("panap_100-95-90.clstr","w", 0) as out:
        subprocess.call(cmd, stdout=out)
    
    cmd=["clstr_rev.pl","panap_100-95-90.clstr","panap_80.clstr"]
    with open("panap_100-95-90-80.clstr", "w", 0) as out:
        subprocess.call(cmd, stdout=out)
    
    cmd=["clstr_rev.pl","panap_100-95-90-80.clstr","panap_70.clstr"]
    with open("panap_100-95-90-80-70.clstr", "w", 0) as out:
        subprocess.call(cmd, stdout=out)
    
    cmd=["clstr_rev.pl","panap_100-95-90-80-70.clstr","panap_60.clstr"]
    with open("panap_100-95-90-80-70-60.clstr", "w", 0) as out:
        subprocess.call(cmd, stdout=out)
    
    cmd=["clstr_rev.pl","panap_100-95-90-80-70-60.clstr","panap_45.clstr"]
    with open("panap_100-95-90-80-70-60-45.clstr", "w", 0) as out :
        subprocess.call(cmd, stdout=out)
